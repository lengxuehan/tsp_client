...
#ifndef TSP_CLIENT_EVP_CIPHER_H
#define TSP_CLIENT_EVP_CIPHER_H
...
bool encrypt(const std::string &str_token, const std::string &str_iv, const std::vector<uint8_t> &plain_message_body,
             std::vector<uint8_t> &whisper_message_body);

bool decrypt(const std::string &str_token, const std::string &str_iv, const std::vector<uint8_t> &whisper_message_body,
             std::vector<uint8_t> &plain_message_body);
