...
#include "openssl_wrapper/base64.h"
...
std::vector<unsigned char> base64_decode_binary(std::string const& encoded_string) {
    std::string str_base64_chars = base64_chars[0];
